...
def generate_hero_html() -> str:
    ...
    for url, label in icons:
        ...
        <div style="display:flex;flex-direction:column;align-items:center;gap:4px;">
          <img src="{url}" width="30" height="30" style="border-radius:6px;" />
          <span style="font-family:'JetBrains Mono',monospace;font-size:8px;font-weight:600;color:#3a3a3a;letter-spacing:0.5px;text-transform:uppercase;">{label}</span>
        </div>"""
